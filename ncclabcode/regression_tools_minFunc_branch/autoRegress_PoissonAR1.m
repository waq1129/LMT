function [wRidge,hprs,SDebars,postHess,logevid] = autoRegress_PoissonAR1(xx, yy, mstruct, rhovals,avals,w0)
% [wRidge,hprs,SDebars,postHess,logevid] = autoRegress_PoissonAR1(xx, yy, mstruct, rhovals,avals,w0);
%
...
fprintf('best grid point: rho=%f, alpha=%f\n', hprsMax);
